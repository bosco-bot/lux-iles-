...
@section('content')
    ...
    {{-- ===================================================================
         Témoignages accueil — MAQUETTE STATIQUE (UX Pilot, remplacée §3.4)
         ===================================================================
    <section id="testimonials-section" class="py-5">
        <div class="container py-5">
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="testimonial-card">… Sophie Martin, Saint-Martin …</div>
                </div>
                <div class="col-md-4">
                    <div class="testimonial-card">… Marc Dubois, Guadeloupe …</div>
                </div>
                <div class="col-md-4">
                    <div class="testimonial-card">… Isabelle Laurent, Marie-Galante …</div>
                </div>
            </div>
        </div>
    </section>
    Copie complète archivée : resources/views/partials/home-testimonials-static.blade.php
    =================================================================== --}}

    @if($featuredReviews->isNotEmpty())
    <!-- Testimonials Section — avis voyageurs publiés (§3.4 CDC) -->
    <section id="testimonials-section" class="py-5">
        <div class="container py-5">
            <div class="text-center mb-5">
                <span class="text-lux-gold text-uppercase mb-3 d-block" style="font-size: 0.875rem; letter-spacing: 0.2em; font-weight: 500;">Témoignages</span>
            ...
            <div class="row g-4">
                @foreach($featuredReviews as $review)
                    <x-home-testimonial-card :review="$review" />
                @endforeach
            </div>
        </div>
    </section>
