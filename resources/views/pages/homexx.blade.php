...
@section('content')
    <!-- Hero Section -->
    <section id="hero-section" class="hero-section" style="background-image: url('https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?q=80&w=2070&auto=format&fit=crop');">
        <div class="container">
            <div class="text-center">
                ...
                <p class="hero-description text-white-90 fs-5 fw-light mb-5 mx-auto" style="max-width: 700px; letter-spacing: 0.02em;">
                    Découvrez une collection exclusive de villas de prestige à Saint-Barthélémy, en Guadeloupe et en Martinique.
                </p>
                ...
                <div class="hero-search">
                    <form method="GET" action="{{ route('villas.index') }}" class="row g-4 align-items-end">
                        <div class="col-md-3">
                            ...
                            <div class="d-flex align-items-center border-bottom pb-2" style="border-color: rgba(138, 150, 166, 0.3) !important;">
                                <i class="fas fa-location-dot text-lux-gold me-3"></i>
                                <select class="form-select border-0 bg-transparent p-0" style="outline: none; appearance: none;" name="island">
                                    <option value="">Toutes les destinations</option>
                                    @foreach($islands as $island)
                                        <option value="{{ $island->id }}">{{ $island->name }}</option>
                                    @endforeach
                                </select>
                                <i class="fas fa-chevron-down text-lux-gray ms-auto" style="font-size: 0.75rem;"></i>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label d-block mb-1" style="font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.1em; color: var(--lux-gray);">
                        ...
                        <article class="villa-card w-100">
                            <a href="{{ route('villas.show', $villa->id) }}" class="text-decoration-none" style="color: inherit;">
                                <div class="position-relative" style="height: 400px; overflow: hidden; border-radius: 8px 8px 0 0;">
                                    ...
                                    <div class="position-absolute top-0 end-0 m-3 bg-white bg-opacity-90 px-3 py-1 rounded" style="backdrop-filter: blur(10px);">
    ...
    <section id="destinations" class="py-5 bg-lux-dark text-white" style="overflow-x: hidden;">
        <div class="container py-5">
            ...
            <div class="row g-4">
                @php
                    // Images par défaut pour les îles non configurées en base (fallback)
                    $defaultImages = [
                ...
                @forelse($destinations as $index => $destination)
                    @php
                        // Utiliser l'image de la BDD, sinon fallback vers les images par défaut, sinon image générique
                        $imageUrl = $destination->image_url ?? ($defaultImages[$destination->name] ?? 'https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?q=80&w=2070&auto=format&fit=crop');
                        // Utiliser la description de la BDD, sinon fallback vers les descriptions par défaut, sinon description générique
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="testimonial-card">
                        ...
                        <p class="text-lux-gray fst-italic mb-4" style="line-height: 1.8;">"Une expérience inoubliable à St-Barth. La villa était absolument magnifique et le service de conciergerie exceptionnel. Nous reviendrons sans hésiter."</p>
                ...
                <div class="col-md-4">
                    <div class="testimonial-card">
                        ...
                        <p class="text-lux-gray fst-italic mb-4" style="line-height: 1.8;">"La Villa Diamant en Martinique a dépassé toutes nos attentes. Vue époustouflante, confort absolu et un accueil chaleureux. Merci LUXÎLES !"</p>
                        <div class="d-flex align-items-center gap-3">
                            <div class="rounded-circle overflow-hidden" style="width: 48px; height: 48px;">
