...
@section('title', 'Messagerie | LUXÎLES - Dashboard')
    ...
    <aside id="conversation-list" class="conversation-list">
        ...
        <div class="flex-grow-1 overflow-y-auto" style="scrollbar-width: none; -ms-overflow-style: none;">
            @if($conversations->count() == 0)
                ...
                <div class="p-4">
                    ...
                    @if(isset($admins) && $admins->count() > 0)
                        <div class="mb-4">
                            <p class="small fw-medium text-lux-blue mb-2">Conciergerie</p>
                            @foreach($admins as $admin)
                                <a href="{{ route('espace-client.messages', ['conversation_id' => 'user_' . $admin->id]) }}" class="d-flex align-items-center gap-3 p-3 rounded text-decoration-none mb-2" style="transition: all 0.3s; background-color: var(--lux-beige);" onmouseover="this.style.backgroundColor='rgba(203, 174, 130, 0.1)'" onmouseout="this.style.backgroundColor='var(--lux-beige)'">
                    ...
                    @if(isset($otherClients) && $otherClients->count() > 0)
                        <div>
                            <p class="small fw-medium text-lux-blue mb-2">Autres clients</p>
                            @foreach($otherClients as $client)
                                <a href="{{ route('espace-client.messages', ['conversation_id' => 'user_' . $client->id]) }}" class="d-flex align-items-center gap-3 p-3 rounded text-decoration-none mb-2" style="transition: all 0.3s; background-color: var(--lux-beige);" onmouseover="this.style.backgroundColor='rgba(203, 174, 130, 0.1)'" onmouseout="this.style.backgroundColor='var(--lux-beige)'">
            ...
            @forelse($conversations as $conversation)
                ...
                @endphp
                <a href="{{ route('espace-client.messages', ['conversation_id' => $conversation['id']]) }}" 
    ...
    <aside class="right-sidebar d-none d-xl-flex">
        ...
        @if($selectedConversation && $activeReservation)
            <div class="p-4 border-bottom" style="border-color: rgba(138, 150, 166, 0.1) !important;">
                ...
                <a href="{{ route('espace-client.reservations') }}" class="btn btn-outline-dark w-100 mt-4 py-2 border-lux-gold text-lux-gold small fw-medium text-decoration-none" style="transition: all 0.3s;" onmouseover="this.style.backgroundColor='var(--lux-gold)'; this.style.color='var(--lux-blue)'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='var(--lux-gold)'">
                    Voir la réservation
                </a>
            </div>
        @endif
            ...
            <div class="p-4 border-bottom" style="border-color: rgba(138, 150, 166, 0.1) !important;">
                ...
                <div class="d-flex flex-column gap-2">
                    ...
                    <a href="{{ route('services.transferts-prives') }}" class="btn btn-link text-start p-3 rounded text-decoration-none d-flex align-items-center gap-3 w-100 border-0" style="color: rgb(10 26 47 / var(--tw-text-opacity, 1)); transition: all 0.3s;" onmouseover="this.style.backgroundColor='var(--lux-white)'; this.querySelector('.service-icon').style.backgroundColor='var(--lux-gold)'; this.querySelector('.service-icon i').style.color='white'" onmouseout="this.style.backgroundColor='transparent'; this.querySelector('.service-icon').style.backgroundColor='rgba(203, 174, 130, 0.1)'; this.querySelector('.service-icon i').style.color='var(--lux-gold)'">
                        <div class="service-icon rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="width: 2rem; height: 2rem; background-color: rgba(203, 174, 130, 0.1); transition: all 0.3s;">
                    ...
                    <a href="{{ route('services.conciergerie') }}" class="btn btn-link text-start p-3 rounded text-decoration-none d-flex align-items-center gap-3 w-100 border-0" style="color: rgb(10 26 47 / var(--tw-text-opacity, 1)); transition: all 0.3s;" onmouseover="this.style.backgroundColor='var(--lux-white)'; this.querySelector('.service-icon').style.backgroundColor='var(--lux-gold)'; this.querySelector('.service-icon i').style.color='white'" onmouseout="this.style.backgroundColor='transparent'; this.querySelector('.service-icon').style.backgroundColor='rgba(203, 174, 130, 0.1)'; this.querySelector('.service-icon i').style.color='var(--lux-gold)'">
                        <div class="service-icon rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="width: 2rem; height: 2rem; background-color: rgba(203, 174, 130, 0.1); transition: all 0.3s;">
                    ...
                    <a href="{{ route('services.activites-exclusives') }}" class="btn btn-link text-start p-3 rounded text-decoration-none d-flex align-items-center gap-3 w-100 border-0" style="color: rgb(10 26 47 / var(--tw-text-opacity, 1)); transition: all 0.3s;" onmouseover="this.style.backgroundColor='var(--lux-white)'; this.querySelector('.service-icon').style.backgroundColor='var(--lux-gold)'; this.querySelector('.service-icon i').style.color='white'" onmouseout="this.style.backgroundColor='transparent'; this.querySelector('.service-icon').style.backgroundColor='rgba(203, 174, 130, 0.1)'; this.querySelector('.service-icon i').style.color='var(--lux-gold)'">
                        <div class="service-icon rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="width: 2rem; height: 2rem; background-color: rgba(203, 174, 130, 0.1); transition: all 0.3s;">
                ...
                <div class="modal-body p-0">
                    @if(isset($admins) && $admins->count() > 0)
                        <div class="p-3 border-bottom">
                            <h6 class="small text-uppercase fw-semibold text-lux-blue mb-3" style="letter-spacing: 0.1em; font-size: 0.75rem;">Conciergerie</h6>
                            <div class="d-flex flex-column gap-2">
                                @foreach($admins as $admin)
                                    <a href="{{ route('espace-client.messages', ['conversation_id' => 'user_' . $admin->id]) }}" class="d-flex align-items-center gap-3 p-2 rounded text-decoration-none" style="transition: all 0.3s;" onmouseover="this.style.backgroundColor='var(--lux-beige)'" onmouseout="this.style.backgroundColor='transparent'">
                                        <div class="position-relative flex-shrink-0">
                                            @if($admin->photo_url)
                                                <img src="{{ asset('storage/' . $admin->photo_url) }}" class="rounded-circle" style="width: 2.5rem; height: 2.5rem; object-fit: cover;" alt="{{ $admin->first_name }}">
                                            @else
                    ...
                    @if(isset($otherClients) && $otherClients->count() > 0)
                        <div class="p-3">
                            <h6 class="small text-uppercase fw-semibold text-lux-blue mb-3" style="letter-spacing: 0.1em; font-size: 0.75rem;">Autres clients</h6>
                            <div class="d-flex flex-column gap-2">
                                @foreach($otherClients as $client)
                                    <a href="{{ route('espace-client.messages', ['conversation_id' => 'user_' . $client->id]) }}" class="d-flex align-items-center gap-3 p-2 rounded text-decoration-none" style="transition: all 0.3s;" onmouseover="this.style.backgroundColor='var(--lux-beige)'" onmouseout="this.style.backgroundColor='transparent'">
                                        <div class="flex-shrink-0">
                                            @if($client->photo_url)
                                                <img src="{{ asset('storage/' . $client->photo_url) }}" class="rounded-circle" style="width: 2.5rem; height: 2.5rem; object-fit: cover;" alt="{{ $client->first_name }}">
                                            @else
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.sendMessage = function() {
        ...
        fetch('{{ route("espace-client.messages.send") }}', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                if (messagesContainer) {
                    ...
                    if (data.message.id) {
                        messageDiv.setAttribute('data-message-id', data.message.id); // Pour éviter les doublons lors de la réception via Echo
                    }
                ...
                // Note: Le message est déjà ajouté au DOM ci-dessus
                // Plus besoin de recharger la page grâce au temps réel
            } else {
        ...
        window.Echo.private('user.' + userId)
            .listen('.message.sent', (data) => {
                if (data.message) {
                    ...
                    // Si le message est pour cette conversation, on pourrait aussi mettre à jour la liste des conversations
                    // (optimisation future : mettre à jour seulement l'élément de la liste sans recharger toute la page)
                }
            });
    }
    ...
    function addMessageToDOM(message) {
        ...
        const messageTime = message.created_at || new Date(message.created_at_full).toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit' });
        
        // Vérifier si on doit ajouter un séparateur de date
        const lastMessage = messagesContainer.querySelector('.d-flex.align-items-end.gap-3:last-of-type');
        let shouldAddDateSeparator = false;
        if (lastMessage) {
            const lastMessageTime = lastMessage.querySelector('.small.text-lux-greyBlue')?.textContent.trim();
            // Logique simplifiée : si c'est le premier message ou si le dernier message date d'une date différente
            shouldAddDateSeparator = true; // Pour simplifier, on peut toujours ajouter le séparateur
        } else {
            shouldAddDateSeparator = true;
        }
        
        const messageDiv = document.createElement('div');
        messageDiv.className = `d-flex align-items-end gap-3 mb-4 ${isFromUser ? 'flex-row-reverse' : ''}`;
        messageDiv.style.cssText = `max-width: 85%; ${isFromUser ? 'margin-left: auto;' : ''}`;
        messageDiv.setAttribute('data-message-id', message.id); // Ajouter un attribut pour identifier le message
        ...
        if (message.attachments && message.attachments.length > 0) {
            message.attachments.forEach(function(attachment) {
                if (attachment.file_type === 'image') {
                    attachmentsHTML += `
                        <div class="mb-2">
                            <img src="${attachment.file_path.startsWith('http') ? attachment.file_path : '/storage/' + attachment.file_path}" alt="${attachment.file_name}" class="img-fluid rounded" style="max-width: 300px; max-height: 300px; cursor: pointer;" onclick="window.open('${attachment.file_path.startsWith('http') ? attachment.file_path : '/storage/' + attachment.file_path}', '_blank')">
                        </div>
                    `;
                } else {
                    attachmentsHTML += `
                        <div class="mb-2">
                            <a href="${attachment.file_path.startsWith('http') ? attachment.file_path : '/storage/' + attachment.file_path}" target="_blank" class="text-decoration-none d-inline-flex align-items-center gap-2 ${isFromUser ? 'text-white' : 'text-lux-text'}">
                                <i class="fa-solid fa-file"></i> ${attachment.file_name}
                            </a>
                        </div>
                    `;
        ...
        const messageBody = message.body ? message.body.replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/\n/g, '<br>') : '';
